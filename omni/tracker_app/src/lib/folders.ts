import type { FolderRow } from "./data"

/** Direct children of a folder (null parent = root), sorted by name. */
...
export function descendantIds(folders: FolderRow[], id: string): Set<string> {
...
export function folderPath(folders: FolderRow[], id: string | null): string {
